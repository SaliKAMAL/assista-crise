...
import { MessageChatDeleteDialog } from './message-chat-delete-dialog';

describe('MessageChat Management Delete Component', () => {
  let comp: MessageChatDeleteDialog;
  let fixture: ComponentFixture<MessageChatDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MessageChatDeleteDialog);
