...
import { CriseDeleteDialog } from './crise-delete-dialog';

describe('Crise Management Delete Component', () => {
  let comp: CriseDeleteDialog;
  let fixture: ComponentFixture<CriseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CriseDeleteDialog);
